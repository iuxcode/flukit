...
class FluBasicTextInputClientState extends State<FluBasicTextInputClient>
  ...
  late final FluToggleButtonsStateManager toggleButtonStateManager;
  ...
  void didChangeDependencies() {
    ...
    toggleButtonStateManager = FluToggleButtonsStateManager.of(context);
  ...
  void _handleSelectionChanged(
    ...
    // Typically FluBasicTextInputClient shouldn't take user keyboard input if
