...
class FluEditableText extends StatefulWidget {
  ...
  /// {@template flutter.widgets.FlueditableText.obscuringCharacter}
  ...
  /// {@template flutter.widgets.FlueditableText.obscureText}
  ...
  /// {@template flutter.widgets.FlueditableText.readOnly}
  ...
  /// {@template flutter.widgets.FlueditableText.showCursor}
  /// Whether to show cursor.
  ///
  /// The cursor refers to the blinking caret when the [FluEditableText] is focused.
  /// {@endtemplate}
  ///
  /// See also:
  ///
  ...
  /// {@template flutter.widgets.FlueditableText.autocorrect}
  ...
  /// {@template flutter.widgets.FlueditableText.strutStyle}
  ...
  /// {@template flutter.widgets.FlueditableText.textAlign}
  ...
  /// {@template flutter.widgets.FlueditableText.textDirection}
  ...
  /// {@template flutter.widgets.FlueditableText.textCapitalization}
  ...
  /// {@template flutter.widgets.FlueditableText.textScaleFactor}
  ...
  /// [CupertinoThemeData.primary] with 20% opacity. For [TextField]s, the
  ...
  /// {@template flutter.widgets.FlueditableText.maxLines}
  ...
  /// [CupertinoTextField], and [FluEditableText].
  ///
  ...
  /// {@template flutter.widgets.FlueditableText.minLines}
  ...
  /// {@template flutter.widgets.FlueditableText.expands}
  ...
  /// {@template flutter.widgets.FlueditableText.autofocus}
  ...
  ///
  /// The [FluEditableText] widget used on its own will not trigger the display
  /// of the selection toolbar by itself. The toolbar is shown by calling
  /// [FluEditableTextState.showToolbar] in response to an appropriate user event.
  ///
  /// See also:
  ///
  ///  * [CupertinoTextField], which wraps an [FluEditableText] and which shows the
  ///    selection toolbar upon user events that are appropriate on the iOS
  ///    platform.
  ///  * [TextField], a Material Design themed wrapper of [FluEditableText], which
  ///    shows the selection toolbar upon appropriate user events based on the
  ///    user's platform set in [ThemeData.platform].
  /// {@endtemplate}
  final TextSelectionControls? selectionControls;

  /// {@template flutter.widgets.FlueditableText.keyboardType}
  ...
  /// {@template flutter.widgets.FlueditableText.onChanged}
  ...
  /// {@template flutter.widgets.FlueditableText.onEditingComplete}
  ...
  /// {@template flutter.widgets.FlueditableText.onSubmitted}
  ...
  /// {@template flutter.widgets.FlueditableText.onAppPrivateCommand}
  ...
  /// {@template flutter.widgets.FlueditableText.onSelectionChanged}
  ...
  /// {@template flutter.widgets.FlueditableText.inputFormatters}
  ...
  ///
  /// The [mouseCursor] is the only property of [FluEditableText] that controls the
  ...
  /// {@template flutter.widgets.FlueditableText.cursorWidth}
  ...
  /// {@template flutter.widgets.FlueditableText.cursorHeight}
  ...
  /// {@template flutter.widgets.FlueditableText.cursorRadius}
  ...
  /// {@template flutter.widgets.FlueditableText.scrollPadding}
  ...
  /// {@template flutter.widgets.FlueditableText.enableInteractiveSelection}
  ...
  /// testing purposes.
  ///
  /// It does not affect the necessity to focus the FluEditableText for the cursor
  ...
  /// {@template flutter.widgets.FlueditableText.scrollController}
  ...
  /// {@template flutter.widgets.FlueditableText.scrollPhysics}
  ...
  /// {@template flutter.widgets.FlueditableText.scribbleEnabled}
  ...
  /// {@template flutter.widgets.FlueditableText.selectionEnabled}
  ...
  /// {@template flutter.widgets.FlueditableText.autofillHints}
  ...
  ///
  /// When null, this widget's [FluEditableTextState] will be used as the
  ...
  /// [FluEditableText].
  ///
  /// If a restoration id is provided, the [FluEditableText] will persist its
  /// current scroll offset and restore it during state restoration.
  ///
  /// The scroll offset is persisted in a [RestorationBucket] claimed from
  /// the surrounding [RestorationScope] using the provided restoration ID.
  ///
  /// Persisting and restoring the content of the [FluEditableText] is the
  ...
  final UpdateInputStyleButtonStateCallback? onDeltaStyleStateChange;

  bool get _userSelectionEnabled =>
      enableInteractiveSelection && (!readOnly || !obscureText);

  // Infer the keyboard type of an `FluEditableText` if it's not specified.
  static TextInputType _inferKeyboardType({
    ...
    // with the content type. To get autofill to work by default on FluEditableText,
  ...
  @override
  FluEditableTextState createState() => FluEditableTextState();
...
class FluEditableTextState extends State<FluEditableText>
  ...
  void selectAll(SelectionChangedCause cause) {
    ...
    userUpdateTextEditingValue(
      textEditingValue.copyWith(
        selection:
            TextSelection(baseOffset: 0, extentOffset: textEditingValue.text.length),
      ),
      cause,
    );
    if (cause == SelectionChangedCause.toolbar) {
  ...
  @override
  void didUpdateWidget(FluEditableText oldWidget) {
  ...
  /// update via [updateEditingValue], or when [FluEditableText] calls
  ...
  void updateEditingValue(TextEditingValue value) {
    ...
    // input plugin. The [FluEditableText] may not have the focus or an open input
    // connection, as autofill can update a disconnected [FluEditableText].
  ...
  void performAction(TextInputAction action) {
    switch (action) {
      case TextInputAction.newline:
        // If this is a multiline FluEditableText, do nothing for a "newline"
  ...
  ///
  /// Throws an error in debug mode if this [FluEditableText] is not in a batch
  /// edit.
  void endBatchEdit() {
    _batchEditDepth -= 1;
    assert(
  ...
  // the main axis.
  //
  // If this is a multiline FluEditableText (which means the Editable can only
  ...
  void _handleSelectionChanged(
    ...
    // text of [FluEditableText] is updated at the same time as the selection is
    ...
    // FluEditableText except for those triggered by a keyboard input.
    // Typically FluEditableText shouldn't take user keyboard input if
    // it's not focused already. If the FluEditableText is being
  ...
  void _cursorWaitForStart(Timer timer) {
    ...
    assert(!FluEditableText.debugDeterministicCursor);
    _cursorTimer?.cancel();
  ...
  void _startCursorTimer() {
    ...
    if (FluEditableText.debugDeterministicCursor) return;
    if (widget.cursorOpacityAnimates) {
  ...
  void _updateSelectionRects({bool force = false}) {
    ...
    final List<Rect> firstSelectionBoxes = renderEditable
      ...
      final List<SelectionRect> rects = List<SelectionRect?>.generate(
        ...
        (int i) {
          ...
          final List<Rect> boxes = renderEditable.getBoxesForSelection(TextSelection(
              baseOffset: offset,
              extentOffset:
                  offset + _cachedText.characters.characterAt(i).string.length));
  ...
  void updateEditingValueWithDeltas(List<TextEditingDelta> textEditingDeltas) {
    ...
    final bool selectionChanged = _value.selection.start != value.selection.start ||
  ...
  @override
  String get autofillId => 'FluEditableText-$hashCode';
  ...
  void _expandSelection(bool forward, _TextBoundary textBoundary,
    ...
    final TextPosition position =
        towardsExtent ? textBoundarySelection.extent : textBoundarySelection.base;
                  ...
                  child: Semantics(
                    ...
                    child: _ScribbleFocusable(
                      ...
                      child: _Editable(
                        ...
                        showCursor: FluEditableText.debugDeterministicCursor
  ...
  TextSpan buildTextSpan() {
    ...
    if (_placeholderLocation >= 0 && _placeholderLocation <= _value.text.length) {
      ...
      if (_isMultiline) {
        ...
        placeholders
            .add(const _ScribblePlaceholder(child: SizedBox(), size: Size.zero));
        placeholders.add(_ScribblePlaceholder(
            child: const SizedBox(), size: Size(renderEditable.size.width, 0.0)));
      } else {
        placeholders.add(
            const _ScribblePlaceholder(child: SizedBox(), size: Size(100.0, 0.0)));
      }
      return TextSpan(
        style: widget.style,
        children: <InlineSpan>[
...
class _CharacterBoundary extends _TextBoundary {
  ...
  TextPosition getLeadingTextBoundaryAt(TextPosition position) {
    ...
    return TextPosition(
      offset: CharacterRange.at(textEditingValue.text, position.offset, endOffset)
          .stringBeforeLength,
    );
  }
  ...
  TextPosition getLeadingTextBoundaryAt(TextPosition position) {
    return isForward
        ...
        : position.offset <= 0
            ? const TextPosition(offset: 0)
            : innerTextBoundary
                .getLeadingTextBoundaryAt(TextPosition(offset: position.offset - 1));
  }
...
class _DeleteTextAction<T extends DirectionalTextEditingIntent>
  ...
  final FluEditableTextState state;
  ...
  Object? invoke(T intent, [BuildContext? context]) {
    ...
    if (!selection.isCollapsed) {
      return Actions.invoke(
        context!,
        ReplaceTextIntent(state._value, '', _expandNonCollapsedRange(state._value),
            SelectionChangedCause.keyboard),
      );
    }
...
class _ExtendSelectionOrCaretPositionAction
  ...
  Object? invoke(ExtendSelectionToNextWordBoundaryOrCaretLocationIntent intent,
    ...
    final TextSelection newSelection = (newExtent.offset -
