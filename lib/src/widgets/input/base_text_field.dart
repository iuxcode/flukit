...
class FluBaseTextField extends StatefulWidget {
  const FluBaseTextField({
    ...
    this.onDeltaStyleStateChange,
        ...
        assert(
          ...
          'Use keyboardType TextInputType.multiline when using TextInputAction.newline on a multiline FluBaseTextField.',
        ),
  ...
  /// showing when it is tapped by calling [FluEditableTextState.requestKeyboard()].
  ...
  /// to [FluBaseTextField.noMaxLength] then only the current character count is displayed.
  ///
  ...
  ///
  /// This value must be either null, [FluBaseTextField.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [FluBaseTextField.noMaxLength], then no limit will
  ...
  /// {@template flutter.material.FluBasetextfield.onTap}
  ...
  ///
  /// The [mouseCursor] is the only property of [FluBaseTextField] that controls the
  ...
  /// {@template flutter.material.FluBasetextfield.restorationId}
  ...
  @override
  State<FluBaseTextField> createState() => _TextFieldState();
...
class _TextFieldState extends State<FluBaseTextField>
  ...
  @override
  void didUpdateWidget(FluBaseTextField oldWidget) {
    ...
    Widget child = RepaintBoundary(
      child: UnmanagedRestorationScope(
        ...
        child: FluEditableText(
          ...
          onDeltasHistoryUpdate: widget.onDeltasHistoryUpdate,
          onDeltaStyleStateChange: widget.onDeltaStyleStateChange,
        ),
      ),
    );
