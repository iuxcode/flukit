...
/// Add [Country] list to [FluInterface]
...
/// Provide data like the `name`, `isoCode`, `iso3Code` and the `phoneCode`
class Country {
  ...
  /// Search a country by providing the `name`,
  /// `iso3Code`, `isoCode` or `phoneCode`
  static Country find(String id) {
    try {
      ...
      throw Exception("Country with the provided id wasn't found!! $e");
    }
  }
